...
const VoiceRecorderDialog = () => {
  ...
  const streamRef = useRef<MediaStream | null>(null); // Store the media stream
  ...
  const handleStopRecording = () => {
    if (mediaRecorderRef.current) {
      ...
      if (streamRef.current) {
        streamRef.current.getTracks().forEach((track) => track.stop()); // Stop all tracks of the media stream
  ...
  const handlePublish = () => {
    handleStopRecording(); // Stop the recording and deactivate the microphone
